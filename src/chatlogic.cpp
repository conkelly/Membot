...
{
// //   //std::cout<<"ChatLogic::AddAllTokensToElement";
...
// //                           //(*childNode)->AddEdgeToParentNode(edge.get()); Advised but returns error.                         
                           (*parentNode)->AddEdgeToChildNode(std::move(edge.get()));
// //                           //std::cout << "LoadAnswerGraphFromFile::MoveArea";
                         }
...
// //  // std::cout<<"ChatLogic::SendMessageToUser";
 ...
 {
// //   //std::cout << "ChatLogic::GetImageFromChatbot";
